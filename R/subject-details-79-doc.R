...
#'    \item{Generation}{Indicates if the subject is in generation `1` or `2`.} 
#'    \item{Gender}{Indicates if the subject is `Male` or `Female`.} 
#'    \item{RaceCohort}{Indicates if the race cohort is `Hispanic`, `Black` or `Nbnh` (*ie*, Non-black, non-hispanic).  This comes from the Gen1 variable `R02147.00` and Gen2 variable `C00053.00`.} 
...
#'    \item{HasMzPossibly}{Indicates if the subject *might* be a member of an MZ twin/triplet. This will be true if there is a sibling with a DOB within a month, and they are the same gender.}
