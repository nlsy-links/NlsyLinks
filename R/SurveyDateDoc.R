...
#' 
#' The exact \emph{date} of birth isn't public (only the subject's \emph{month} of birth).  To balance the downward bias, a constant
#' of 0.5 years has been added to produce \code{AgeCalculateYears}.  In the Gen2 Child dataset, self-reported age is
