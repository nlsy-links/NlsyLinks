...
This submission revival of a package archived from April of 2021. I (Mason Garrison) am taking over as the maintainer from Will Beasley. As part of that process, I am getting reviving this package. My first goal is getting this package pack on CRAN as a single package, so that folks in the field of behavior genetics can have access to the tools and data. After the package is revived, I fully plan to split up the packages into a data package. I have already begun that process here, but it will take some time to do that.  
