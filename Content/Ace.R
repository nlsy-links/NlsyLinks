#AceUnivariate <- function( outcomeForSubject1, outcomeForSubject2, relatedness, method=c("DeFriesFulkerMethod1", "DeFriesFulkerMethod3"), manifestScale="Continuous" ) {
AceUnivariate <- function( method=c("DeFriesFulkerMethod1","DeFriesFulkerMethod3"), dataSet, oName_1, oName_2, rName="R", manifestScale="Continuous" ) {
  #print( length(method) )
  if( length(method) != 1 )
