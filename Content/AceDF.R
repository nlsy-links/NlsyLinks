DeFriesFulkerMethod1 <- function( dataSet, oName_1, oName_2, rName="R" ) { 
...
DeFriesFulkerMethod3 <- function( dataSet, oName_1, oName_2, rName="R" ) { 
...
# DeFriesFulkerMethod1 <- function( outcomeForSubject1, outcomeForSubject2, relatedness ) {   
...
#   #return( list(ASquared=b3, CSquared=b1, ESquared=eSquared, RowCount=nDouble) )
# }
# DeFriesFulkerMethod3 <- function( outcomeForSubject1, outcomeForSubject2, relatedness ) { 
