...
x$Link=paste0("<a href='",x$Link,"'>",x$Link,"</a>")
m = matrix(as.matrix(x),ncol=6)

colnames(m) = c('Number','Citation','Year','NLSY79','NLSYC','Link')
...
<li value=65><cite>Garrison, S. M., Rodgers, J. L. (2016) Casting doubt on the causal link between intelligence and age at first intercourse: A cross-generational sibling comparison design using the NLSY. *Intelligence*,59,139-156.<em class="doi">doi:10.1016/j.intell.2016.08.008</em></cite>(NLSY79; NLSYC)</li>
