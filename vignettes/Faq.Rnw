...
The current \href{https://cran.r-project.org/package=NlsyLinks/vignettes/Faq.pdf}{FAQ} and the \href{https://cran.r-project.org/package=NlsyLinks/vignettes/NlsyAce.pdf}{NLSY ACE vignette} provide overview, and the \href{https://cran.r-project.org/package=NlsyLinks/NlsyLinks.pdf}{reference manual} describe the package's syntax and functions; the documents are available on \href{https://cran.r-project.org/package=NlsyLinks}{CRAN}.
