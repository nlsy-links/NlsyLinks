...
- Kelly [Williams](https://www.linkedin.com/in/kelly-m-williams-phd-71189055/) (Oklahoma City University, OKC)
...
This website is maintained by the [Joe Rodgers](https://www.vanderbilt.edu/psychological_sciences/bio/joe-rodgers) NLSY Sibling Research Team (see the [collaborators](./about-collaborators.html) page for more details)

The website is hosted on [GitHub Pages](https://pages.github.com/).  It is built with [Jekyll](https://jekyllrb.com/) and [R Markdown](https://rmarkdown.rstudio.com/) (and heavily relied on the latter when forming the site's structure).  The majority of the static reports are created with  [knitr](https://yihui.org/knitr/), while the interactive reports are created with [Shiny](https://shiny.rstudio.com/); both use 
