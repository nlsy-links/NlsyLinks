...
Welcome to the `NlsyLinks` package, which facilitates research with the [NLSY](http://www.bls.gov/nls/home.htm).  The initial focus of the package was to assist behavior genetics, but it has been expanded to help with NLSY research in general.
