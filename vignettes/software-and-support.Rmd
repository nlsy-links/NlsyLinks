...
The [`NlsyLinksDetermination` repository](https://github.com/nlsy-links/nlsy-links-determination-2017) contains the [C#](https://en.wikipedia.org/wiki/C_Sharp_%28programming_language%29) code that manipulates the NLSY data to produce the relatedness values.  If you're only interested in the R package (and not how the relatedness coefficients were determined), then please see the [`NlsyLinks`](./research-software-and-support.html#nlsylinks-and-examples-for-r) package described above.
