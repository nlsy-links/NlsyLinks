...
After the most recent release of the [NLSY79 and NLSYC/YA kinship links](https://github.com/nlsy-links/NlsyLinks/tree/master/NlsyLinks/OutsideData) in November, 2013 (developed by Will Beasley, Kelly Meredith, David Bard, and Joe Rodgers), we have provided the [algorithm online as open-source code](https://github.com/nlsy-links/NlsyLinksDetermination), and users are welcome to adapt it to their own purposes.
