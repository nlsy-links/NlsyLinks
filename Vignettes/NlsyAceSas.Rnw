...
\end{abstract}  
\tableofcontents
<<preliminaries, echo=FALSE, print=FALSE, cache=TRUE>>=
opts_chunk$set(echo=TRUE)
options(width=88, show.signif.stars = FALSE, continue=" ") 
@
...
<<eval=TRUE, echo=TRUE, tidy=FALSE, cache=TRUE>>=
...
<<eval=TRUE, echo=TRUE, tidy=FALSE, message=FALSE, cache=TRUE>>=
